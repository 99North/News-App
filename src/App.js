...
function AppContent({ theme, toggleTheme, categoryData }) {
  ...
  const showFooter =
    ...
    location.pathname.startsWith("/astrospeak") ||
    ...
    <div className={`App ${theme}`}>
      ...
      <main className="main-container">
        <Routes>
          ...
          <Route
            path="/odisha/article1"
            element={<OdishaArticle1 theme={theme} />}
          />
          <Route
            path="/odisha/article2"
            element={<OdishaArticle2 theme={theme} />}
          />
          <Route
            path="/national/article1"
            element={<NationalArticle1 theme={theme} />}
          />
          <Route
            path="/national/article2"
            element={<NationalArticle2 theme={theme} />}
          />
          <Route
            path="/international/article1"
            element={<InternationalArticle1 theme={theme} />}
          />
          <Route
            path="/international/article2"
            element={<InternationalArticle2 theme={theme} />}
          />
          <Route
            path="/entertainment/article1"
            element={<EntertainmentArticle1 theme={theme} />}
          />
          <Route
            path="/entertainment/article2"
            element={<EntertainmentArticle2 theme={theme} />}
          />
          <Route
            path="/jobs/article1"
            element={<JobsArticle1 theme={theme} />}
          />
          <Route
            path="/jobs/article2"
            element={<JobsArticle2 theme={theme} />}
          />
          <Route
            path="/education/article1"
            element={<EducationArticle1 theme={theme} />}
          />
          <Route
            path="/education/article2"
            element={<EducationArticle2 theme={theme} />}
          />
          <Route
            path="/astrospeak/article1"
            element={<AstrospeakArticle1 theme={theme} />}
          />
          <Route
            path="/astrospeak/article2"
            element={<AstrospeakArticle2 theme={theme} />}
          />
          <Route
            path="/health/article1"
            element={<HealthArticle1 theme={theme} />}
          />
          <Route
            path="/health/article2"
            element={<HealthArticle2 theme={theme} />}
          />
          <Route
            path="/environment/article1"
            element={<EnvironmentArticle1 theme={theme} />}
          />
          <Route
            path="/environment/article2"
            element={<EnvironmentArticle2 theme={theme} />}
          />
        ...
        [
          {
            id: 1,
            title:
              "Bhubaneswar Smart City Project Wins International Recognition",
            excerpt:
              "Capital city awarded Global Smart City Award for innovative urban planning...",
            category: "ODISHA",
            date: "March 10, 2022",
            image:
          ...
          },
          {
            id: 2,
            title:
              "Odisha Becomes Leader in Renewable Energy with Massive Solar Park",
            excerpt:
              "State inaugurates India's largest solar park with 2,000 MW capacity...",
            category: "ODISHA",
            date: "March 11, 2022",
            image:
          ...
          },
          {
            id: 3,
            title:
              "Konark Sun Temple Restoration Project Completed Successfully",
            excerpt:
              "Historic temple undergoes major restoration work preserving ancient architecture...",
            category: "ODISHA",
            date: "March 12, 2022",
            image:
          ...
          },
          {
            id: 4,
            title:
              "Odisha Launches Digital Healthcare Initiative for Rural Areas",
            excerpt:
              "Telemedicine program connects remote villages with specialist doctors...",
            category: "ODISHA",
            date: "March 13, 2022",
            image:
          ...
          },
          {
            ...
            excerpt:
              "Asia's largest brackish water lagoon sees biodiversity increase by 40%...",
            category: "ODISHA",
            date: "March 14, 2022",
            image:
          ...
          },
          {
            ...
            excerpt:
              "State emerges as new IT destination with infrastructure rivaling Bengaluru...",
            category: "ODISHA",
            date: "March 15, 2022",
            image:
        ...
        [
          {
            id: 1,
            title:
              "India Becomes Third Largest Economy Overtaking Japan and Germany",
          ...
          },
          {
            id: 2,
            title:
              "Digital India Reaches Milestone with 1 Billion Internet Users",
            excerpt:
              "Country achieves remarkable digital connectivity milestone...",
            category: "NATIONAL",
            date: "March 13, 2022",
            image:
        ...
        [
          {
            ...
            excerpt:
              "Nearly 200 nations commit to unprecedented climate action...",
            category: "INTERNATIONAL",
            date: "March 14, 2022",
            image:
              "https://images.unsplash.com/photo-1569163139394-de4798aa62b6?w=600&q=80",
            route: "/international/article1",
          },
          {
            id: 2,
            title:
              "European Union Announces Ambitious Digital Currency Initiative",
            excerpt:
              "ECB launches digital euro project for 340 million citizens...",
            category: "INTERNATIONAL",
            date: "March 15, 2022",
            image:
      ...
      articles: addLatestBadge(
        [
          ...
          },
          {
            ...
            excerpt:
              "Major platforms commit to diverse language productions...",
            category: "ENTERTAINMENT",
            date: "March 17, 2022",
            image:
      ...
      articles: [
        {
          id: 1,
          title:
            "Tech Sector Creates 2 Million Jobs Amid Digital Transformation",
        ...
        },
        {
          ...
          excerpt:
            "Initiative to train 10 million youth in industry-relevant skills...",
          category: "JOBS",
          date: "March 19, 2022",
          image:
        ...
        [
          {
            ...
            excerpt:
              "NEP 2020 implementation brings holistic learning approach...",
            category: "EDUCATION",
            date: "March 20, 2022",
            image:
      ...
      articles: [
        {
          ...
          excerpt:
            "Scientific observations confirm ancient astronomical predictions...",
          category: "ASTROSPEAK",
          date: "March 22, 2022",
          image:
        ...
        },
        {
          ...
          excerpt:
            "Five-planet alignment creates unique astrological significance...",
          category: "ASTROSPEAK",
          date: "March 23, 2022",
          image:
        ...
        [
          {
            ...
            excerpt:
              "World's largest single-year reforestation effort completed...",
          ...
          },
          {
            ...
            excerpt:
              "Comprehensive initiative tackles plastic pollution crisis...",
            category: "ENVIRONMENT",
            date: "March 27, 2022",
            image:
